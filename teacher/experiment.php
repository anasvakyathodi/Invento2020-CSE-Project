...
<html lang="en">
  <head>
    ...
    <title>Experiment | Teacher</title>
  </head>
  <body>
    ...
    <div class="container py-4 maincontent">
      <div class="row py-4">
        ...
        <div class="col customcontent">
          ...
          <div class="tocheck">
          <label for="">To Check</label>
          <a href="" type="button" class="btn btn-outline-dark">60. Aswathy</a>
          <a href="" type="button" class="btn btn-outline-dark">14. Anaswara</a>
          <a href="" type="button" class="btn btn-outline-dark">10. Amal</a>
          </div>
          <div class="notsubmitted">
          <label for="">Not Submitted</label>
          <a href="" type="button" class="btn btn-outline-dark">12. Anand</a>
          <a href="" type="button" class="btn btn-outline-dark">66. Sreedev</a>
          </div>
          <div class="completed">
          <label for="">Completed</label>
          <a href="" type="button" class="btn btn-outline-dark">65. Rentu</a>
          <a href="" type="button" class="btn btn-outline-dark">64. Suchithra</a>
          <a href="" type="button" class="btn btn-outline-dark">11. Anamika</a>
          </div>
          </div>
        </div>
      </div>
